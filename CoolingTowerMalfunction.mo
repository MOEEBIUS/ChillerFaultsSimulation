...
equation
  ...
  connect(Level_1.y, CondensedWaterIn.in_T) annotation (Line(points={{-109,78},{
          -72.2,78},{-72.2,66}}, color={0,0,127}));
  ...
  annotation (Documentation(info="<HTML>
    <p><big> This model allows the user to simulate the Fault Cooling Tower Malfunction in a Chiller system.
    ...
    <p><big> The fault Cooling Tower Malfunction can be simulated by a ramp input connected to the condenser water inlet Temperature. 
